...
/////////////////////////////////////////////////
export const page = (s: string, page_ = 1, perPage = 25) =>
...
/////////////////////////////////////////////////
export const sectionMediaFields = `id
${title}
siteUrl
startDate{
    ${dateFields}
...
/////////////////////////////////////////////////
export const characterFields = `id
role
node{
    id
    ${name}
...
/////////////////////////////////////////////////
export const mediaFields = `${sectionMediaFields}
trailer{
    id
    site
    thumbnail

...
export const PlaygroundLights = forwardRef((props, ref: Ref<SpotLight>) => {
...
function PostEffect() {
    ...
    const handleGodray = godray => {
        ...
        godray.godRaysPass.fullscreenMaterial.onBeforeCompile = (
            shader,
            renderer,
        ) => {
    ...
    const handleSun = useCallback((sun: Mesh) => {
        sunRef.current = sun;
        setGodray(
            <GodRays
                ref={handleGodray}

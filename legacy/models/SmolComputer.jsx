...
import { playAnimationsOnClick } from '../utils/hooks'
import { playAnimation, playAnimationsIndefinitely } from '../utils/utils'

export default function SmolComputer({ ...props }) {
    const group = useRef()
    const { nodes, materials, animations } = useGLTF('/models/smolcomputer/scene.gltf')
    const { actions } = useAnimations(animations, group)
    console.log(actions);
    useEffect(() => {
        playAnimationsIndefinitely([actions.Animation])
    })
...
useGLTF.preload('/models/smolcomputer/scene.gltf')

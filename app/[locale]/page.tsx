            ...
            <div className="std-bg flex h-fit w-full flex-col items-center justify-center">
                ...
                <div className="mt-4 flex w-full flex-col items-center justify-center">
                    ...
                    <div className="flex w-full flex-row flex-wrap items-center justify-center gap-2 md:gap-4 xl:gap-6">
                        ...
                        <NavItem className="std-pad" locale={locale} messages={messages} href={"/about"}>
                        ...
                        <NavItem className="std-pad" locale={locale} messages={messages} href={"/anime"}>
                        ...
                        <NavItem className="std-pad" locale={locale} messages={messages} href={"/rss"}>
                        ...
                        <NavItem className="std-pad" locale={locale} messages={messages} href={"/shader"}>

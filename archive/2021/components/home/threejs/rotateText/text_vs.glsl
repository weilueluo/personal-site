...
#pragma glslify: make_translation = require('../../../common/shaders/partials/translation.glsl')
#pragma glslify: make_local_rotation = require('../../../common/shaders/partials/local_rotation.glsl')

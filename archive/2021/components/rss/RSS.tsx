...
import { FeedsMap, FlatFeed, FilterSection, RSSRequestError } from './RSS.d';
...
export default function RSS() {
    ...
    const [flatFeeds, setFlatFeeds] = useState<FlatFeed[]>([]);
...
type RSSContentProps = {
    ...
    flatFeedsState: [
        FlatFeed[],
        Dispatch<SetStateAction<FlatFeed[]>>,
    ];
...
function RSSContent(props: RSSContentProps) {
    return (

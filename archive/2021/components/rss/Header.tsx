...
import { type FilterSection, type FlatFeed, type RSSRequestError } from './RSS.d';

type RSSHeaderProps = {
    flatFeedsState: [FlatFeed[], Dispatch<SetStateAction<FlatFeed[]>>];
    filterActiveState: [boolean, Dispatch<SetStateAction<boolean>>];
    filterSectionsState: [
        FilterSection[],
        Dispatch<SetStateAction<FilterSection[]>>,
    ];
    errorActiveState: [boolean, Dispatch<SetStateAction<boolean>>];
    rssLoader: RSSLoader;
...
export default function RSSHeader(props: RSSHeaderProps) {
